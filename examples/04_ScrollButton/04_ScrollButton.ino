/**
 * EVA Core | EVA Survival Kit - ScrollButton with Custom KeyPad Demo
 *
 * Two input methods:
...
private:
  ...
  /** @brief Shared handler for both volume buttons (up and down) */
  ...
  /** @brief Handler for the navigation keypad */
